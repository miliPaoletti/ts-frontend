export const Promotion = ({ promotion, component }) => {
  ...
  //   } else {
  //     return (
  //       <div className="bg-yellow-500 text-white font-semibold text-xs text-center p-2 py-4 font-[Rubik] rounded-md">
  //         Consultar promoción disponible
  //       </div>
  //     );
  //   }
  // }
  //   TODO: mejorar este código para que no quede repetido
  // if (promotion !== 0) {
  //   if (component === "card") {
  //     return (
  //       <div className="shadow-md z-10 absolute right-[15px]  bg-yellow-500 text-white rounded-b-lg py-2 px-4 text-center font-[Rubik]">
